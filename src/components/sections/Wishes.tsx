...
const Wishes = () => {
  ...
  return (
    <section id="wishes" className="relative w-full overflow-y-hidden overflow-x-hidden">
      ...
      {/* Gradient Top */}
        <div className="absolute top-0 left-0 w-full h-[60vw] z-20 bg-gradient-to-b from-white from-55% to-transparent" />
        {/* Gradient Bottom */}
      ...
      {/* ORNAMENT */}
      {/* Layer Atas */}
      {/* <div className="absolute top-0 -right-[4vw] w-[125vw] h-[50vw] z-40 ">
        <Image
          src="/images/Wishes/Layer-Atass.webp"
          alt=""
          width={1077}
          height={257}
      ...
      <Image
        ...
        width={147}
        height={108}
        className="absolute top-[2%]  w-[20vw] left-[5vw] z-40"
      />

      {/* Layer Bawah */}
      {/* <div className="absolute -bottom-[3vw] -left-[5vw] w-[110vw] h-[77vw] z-40 overflow-hidden opacity-80">
        <Image
          src="/images/Wishes/Layer-Bawahh.webp"
          alt=""
          fill
          className="object-cover"
        />
      ...
      {/* <div className="absolute -bottom-[0vw] right-[0vw] w-[105vw] h-[40vw] z-[55] overflow-hidden opacity-80">
        <Image
        src="/images/Wishes/Glitter-Bawah.webp"
          alt=""
          fill
          className="object-cover"
        />
      ...
      {/* Konten */}
      <div className="relative z-60 flex flex-col items-center text-center px-[8.5vw]">
        ...
        <div
          className="relative z-[90] w-full px-[4.4vw] pt-[30vw] pb-[50.26vw] flex flex-col items-center"
        >
