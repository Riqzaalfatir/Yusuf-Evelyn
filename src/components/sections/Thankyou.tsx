...
const ThankYou: React.FC = () => {
  return (
    <div
      className="relative w-full overflow-hidden aspect aspect-[390/801] lg:aspect-[1512/918]"
    >
      <img
      ...
      <div className="absolute top-[27vw] lg:top-[10.5vw] left-0 right-0 z-10 flex flex-col items-center text-center px-8 leading-none">
        <h1 className="font-bigCaslon text-[40px] lg:text-[3.439vw] text-white">Thank You</h1>
